...
function Library:SetDragVisual(Instance, Enabled)
    ...
    if Instance:IsA('CanvasGroup') then
        ...
        Library:Tween(Instance, {
            BackgroundTransparency = Enabled and (Ghost * 0.6) or 0;
        }, 0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.Out);
    end;
end;
...
function Library:CreateWindow(...)
    ...
    -- Shared sliding pill under the active main tab (top edge).
    ...
    local function MoveTabSlider(Button, Instant)
        ...
        local GoalPos = UDim2.new(0, RelX + 5, 0, 2);
        ...
        function Tab:AddTabbox(Info)
            ...
            function Tabbox:AddTab(Name)
                ...
                function Tab:Show()
                    ...
                    Library:Tween(TopBar, { Size = UDim2.new(1, -12, 0, 2) }, Library.Anim.Tab, Enum.EasingStyle.Quart, Enum.EasingDirection.Out);
