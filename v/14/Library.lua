    ...
    function Funcs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            ...
            Outer.InputEnded:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    Outer:SetAttribute('Pressed', false);
                    local Hovering = Outer.AbsolutePosition.X <= Library:GetMouse().X
                        and Library:GetMouse().X <= Outer.AbsolutePosition.X + Outer.AbsoluteSize.X
                        and Outer.AbsolutePosition.Y <= Library:GetMouse().Y
                        and Library:GetMouse().Y <= Outer.AbsolutePosition.Y + Outer.AbsoluteSize.Y;
