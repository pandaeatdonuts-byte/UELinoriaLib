...
-- Clean top accent: clipped to the rounded shell, inset so it never paints the sides.
function Library:AddAccentBar(Parent, Radius, ZIndex)
    Radius = Radius or Library.CornerRadius;
    ZIndex = ZIndex or 2;
    local Thickness = 2;
    local Inset = math.max(Radius, 8);
    ...
    local Holder = Library:Create('Frame', {
        ...
        Size = UDim2.new(1, 0, 0, Radius + Thickness);
    ...
    Library:AddCorner(Holder, Radius);
...
function Library:SetDragVisual(Instance, Enabled)
    -- Kept for compatibility; window drag no longer uses ghosting.
end;

-- Classic Linoria drag: instant follow, no smoothing / ghosting.
function Library:MakeDraggable(Instance, Cutoff)
    ...
    Instance.InputBegan:Connect(function(Input)
        ...
        -- Lock current on-screen place into offset-space (fixes Center = true).
        ...
        local Grab = Vector2.new(
            Mouse.X - Instance.Position.X.Offset,
            Mouse.Y - Instance.Position.Y.Offset
        );

        while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do
            Instance.Position = UDim2.fromOffset(Mouse.X - Grab.X, Mouse.Y - Grab.Y);
            RenderStepped:Wait();
        end;
    end);
end;
...
do
        ...
        local function CreateBaseButton(Button)
            ...
            Outer.MouseEnter:Connect(function()
                if not Outer:GetAttribute('Pressed') then
                    Library:Tween(Scale, { Scale = 1.035 }, Library.Anim.Button, Enum.EasingStyle.Back, Enum.EasingDirection.Out);
                end;
            end);

            Outer.MouseLeave:Connect(function()
                Outer:SetAttribute('Pressed', false);
                Library:Tween(Scale, { Scale = 1 }, Library.Anim.Button, Enum.EasingStyle.Quad, Enum.EasingDirection.Out);
            end);

            Outer.InputBegan:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    Outer:SetAttribute('Pressed', true);
                    Library:Tween(Scale, { Scale = 0.97 }, 0.08, Enum.EasingStyle.Quad, Enum.EasingDirection.Out);
                    Library:Tween(Outer, { BackgroundColor3 = Library.AccentColor }, 0.08, Enum.EasingStyle.Quad, Enum.EasingDirection.Out);
                    Library:Tween(Label, { TextColor3 = Color3.new(1, 1, 1) }, 0.08);
                end;
            end);
            ...
            Outer.InputEnded:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    Outer:SetAttribute('Pressed', false);
                    local Hovering = Outer.AbsolutePosition.X <= Mouse.X
                        and Mouse.X <= Outer.AbsolutePosition.X + Outer.AbsoluteSize.X
                        and Outer.AbsolutePosition.Y <= Mouse.Y
                        and Mouse.Y <= Outer.AbsolutePosition.Y + Outer.AbsoluteSize.Y;

                    Library:Tween(Scale, { Scale = Hovering and 1.035 or 1 }, Library.Anim.Button, Enum.EasingStyle.Back, Enum.EasingDirection.Out);
                    Library:Tween(Outer, {
                    ...
                    Library:Tween(Label, { TextColor3 = Library.FontColor }, Library.Anim.Button);
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        local TogglePop = Library:Create('UIScale', {
            Scale = 1;
            Parent = ToggleOuter;
        });
        ...
        function Toggle:Display()
            ...
            TogglePop.Scale = 0.86;
            Library:Tween(TogglePop, { Scale = 1 }, Library.Anim.Pop * 0.75, Enum.EasingStyle.Back, Enum.EasingDirection.Out);
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:OpenDropdown()
            ...
            local Pop = ListOuter:FindFirstChild('DropPop') or Library:Create('UIScale', {
                Name = 'DropPop';
                Scale = 0.92;
                Parent = ListOuter;
            });
            ...
            Library:Tween(Pop, { Scale = 1 }, Library.Anim.Pop, Enum.EasingStyle.Back, Enum.EasingDirection.Out);
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local function SlideTab(Frame, Show, Direction)
            ...
            local Width = math.max(TabContainer.AbsoluteSize.X, 120);
            local Offset = math.floor(Width * 0.35);
            ...
            if Show then
                ...
                }, Duration * 0.7, Enum.EasingStyle.Quart, Enum.EasingDirection.In);
            end;
        end;
        ...
        function Tab:HideTab(Direction)
            ...
            if TabFrame.Visible then
                ...
                task.delay(Library.Anim.Tab * 0.7, function()
        ...
        function Tab:AddTabbox(Info)
            ...
            -- Nested tabs: single bottom underline (no dual top/bottom bars).
            ...
            function Tabbox:AddTab(Name)
                ...
                function Tab:Show()
                    ...
                    Library:Tween(Underline, { Size = UDim2.new(1, -12, 0, 2) }, Library.Anim.Tab, Enum.EasingStyle.Quart, Enum.EasingDirection.Out);
    ...
    function Library:Toggle()
        ...
        if Toggled then
            ...
            local WinPop = Outer:FindFirstChild('WinPop') or Library:Create('UIScale', {
                Name = 'WinPop';
                Scale = 0.96;
                Parent = Outer;
            });
            WinPop.Scale = 0.96;
            Library:Tween(WinPop, { Scale = 1 }, Library.Anim.Pop, Enum.EasingStyle.Back, Enum.EasingDirection.Out);
        else
